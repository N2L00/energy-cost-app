...
with st.expander(t("settings_expander", language)):
    tab_exchange, tab_budget, tab_outage, tab_generator, tab_language, tab_delete = st.tabs([
        t("exchange_rate_expander", language),
        t("budget_expander", language),
        t("outage_schedule_expander", language),
        t("generator_capacity_expander", language),
        t("language_expander", language),
        t("delete_business_expander", language),
    ])
