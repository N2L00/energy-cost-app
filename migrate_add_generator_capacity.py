"""One-off migration: add the 'generator_capacity_kva' column to the businesses table.
...
if column_exists("businesses", "generator_capacity_kva"):
    print("'generator_capacity_kva' column already exists on 'businesses' — nothing to do.")
else:
    with engine.begin() as conn:
        conn.execute(text("ALTER TABLE businesses ADD COLUMN generator_capacity_kva FLOAT"))
    print("Added 'generator_capacity_kva' column to 'businesses'.")
